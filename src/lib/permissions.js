...
const rolePermissions = {
  ...
  [ROLES.FINANCE_OFFICER]: ['dashboard.view', 'staff.view', 'staff.manage', 'payroll.view', 'payroll.prepare', 'payroll.setup.view', 'payroll.setup.manage', 'payslips.preview', 'delivery.view', 'salary.view', 'profile.view', 'profile.edit', 'notifications.view'],
...
export const routePermissions = {
  ...
  '/payroll/setup': 'payroll.setup.view',
