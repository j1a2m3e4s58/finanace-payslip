...
function BrandPanel() {
  return (
    <section className="auth-brand-panel relative h-[17rem] shrink-0 overflow-hidden sm:h-[19rem] lg:h-auto lg:min-h-[100dvh]">
      ...
      <div className="auth-brand-rings absolute left-1/2 top-[46%] h-[17rem] w-[17rem] -translate-x-1/2 -translate-y-1/2 rounded-full sm:h-[22rem] sm:w-[22rem] lg:left-[42%] lg:top-[42%] lg:h-[25rem] lg:w-[25rem]" aria-hidden="true" />
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-5 pb-8 pt-8 lg:items-start lg:justify-between lg:px-[7%] lg:py-[7vh]">
        ...
        <div className="relative grid h-40 w-40 place-items-center rounded-full border-2 border-[#d7ad37] bg-white/95 shadow-[0_24px_70px_-20px_rgba(0,0,0,.75)] ring-[16px] ring-[#005437]/80 sm:h-52 sm:w-52 sm:ring-[18px] lg:ml-[18%] lg:h-64 lg:w-64 lg:ring-[26px]">
...
export default function AuthLayout({ children, className }) {
  ...
  return (
    <main className="relative min-h-[100dvh] overflow-x-hidden bg-background lg:grid lg:grid-cols-[minmax(0,1.08fr)_minmax(31rem,.92fr)]">
      ...
      <BrandPanel />
      <section className="relative -mt-10 flex min-w-0 min-h-[calc(100dvh-15rem)] items-start justify-center px-4 pb-4 pt-0 sm:min-h-[calc(100dvh-17rem)] sm:px-7 sm:pb-8 lg:mt-0 lg:min-h-[100dvh] lg:items-center lg:px-8 lg:py-5">
